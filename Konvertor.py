...
Label(root,text='Coversion System',font=('times new rommon',60,'bold'),bg='white',fg='cyan',relief=RIDGE).pack(pady=10)
...
btn1=Button(root,text='Converter',font='arial 20 bold',fg='black',bg='lime',width=10,relief=GROOVE,bd=10,command=convert)
btn1.place(x=300,y=600)

btn2=Button(root,text='Clear',font='arial 20 bold',fg='white',bg='crimson',width=10,relief=GROOVE,bd=10,command=clear)
btn2.place(x=600,y=600)

btn3=Button(root,text='Exit',font='arial 20 bold',fg='crimson',bg='white',width=10,relief=GROOVE,bd=10,command=exit)
